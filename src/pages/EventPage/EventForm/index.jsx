...
const EventForm = function ({
    ...
    return (
        <div>
            ...
            <div className="event-form-date">Начало: {Moment(event.startDate).format('YYYY/MM/DD HH:mm')}</div>
            <div className="event-form-date">Конец: {Moment(event.endDate).format('YYYY/MM/DD HH:mm')}</div>
          ...
          />
            ...
            <div className="reviews">
                ...
                <ul>
                    {event.reviews != null ? event.reviews.map((item) => (

                        <li className="review">
                            <Card>
                                <Card.Header>{item.username}</Card.Header>
                                <Card.Body>{item.review}</Card.Body>
                            </Card>
                        </li>
                    )) : (
                        <li>
